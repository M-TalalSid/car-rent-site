...
export default function PickDropForm() {
  const [] = useState("13 October 2024");
  const [] = useState("12.00");
  const [] = useState("31 December 2024");
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-col-3 justify-between">
          ...
          <DropdownField label="Date" value="13 October 2024" disabled />
          <DropdownField label="Time" value="12.00" disabled />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-col-3 justify-between">
          <DropdownField label="Locations" value="Kota Semarang" disabled />
          <DropdownField label="Date" value="31 December 2024" disabled />
